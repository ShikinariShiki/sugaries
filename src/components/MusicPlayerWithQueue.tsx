          ...
          {showQueue && (
            ...
            >
              ...
              <div className="px-4 py-3 border-b border-gray-100 dark:border-white/10 flex items-center justify-between">
                <h3 className="text-sm font-medium text-gray-900 dark:text-white/90">Queue</h3>
                ...
                {queue.map((song, index) => (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className="text-sm text-gray-400 dark:text-white/40 font-medium min-w-[20px]">
                        {index + 1}.
                      </div>
                      <div className="flex-1 min-w-0">
                        <div className={`text-sm font-medium truncate ${index === currentSongIndex ? 'text-pink-500 dark:text-pink-400' : 'text-gray-900 dark:text-white/90'
                          }`}>
                          {song.title}
                        </div>
          ...
          {isMinimized ? (
            ...
            <div className="p-2 flex flex-col items-center gap-2">
              ...
              <button
                ...
                className="w-6 h-6 flex items-center justify-center rounded-full bg-gray-100 dark:bg-white/10 hover:bg-gray-200 dark:hover:bg-white/20 text-gray-500 dark:text-white/70 text-xs"
                title="Expand player"
              >
                ↑
              </button>
            ...
            <>
                ...
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="text-gray-400 dark:text-white/50 hover:text-gray-900 dark:hover:text-white/90 transition-colors"
                      title="Toggle queue"
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button
                      ...
                      className="w-6 h-6 flex items-center justify-center rounded-full bg-gray-100 dark:bg-white/10 hover:bg-gray-200 dark:hover:bg-white/20 text-gray-500 dark:text-white/70 hover:text-gray-900 dark:hover:text-white text-sm font-bold transition-colors"
              ...
              <div className="px-4 py-3">
                <div className="flex items-center justify-between text-xs text-gray-400 dark:text-white/50 mb-2">
                ...
                <input
                  ...
                  value={currentTime}
                  onChange={handleSeek}
                  className="w-full h-1 bg-gray-200 dark:bg-white/10 rounded-lg appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-pink-500 [&::-webkit-slider-thumb]:cursor-pointer"
                />
              </div>
              ...
              <div className="px-4 py-3 flex items-center justify-between">
                ...
                <button
                  ...
                  className="p-2 text-gray-400 dark:text-white/70 hover:text-gray-900 dark:hover:text-white transition-colors"
                >
              ...
              <div className="px-4 pb-4 flex items-center gap-3">
                ...
                <input
                  ...
                  className="flex-1 h-1 bg-gray-200 dark:bg-white/10 rounded-lg appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-pink-500 [&::-webkit-slider-thumb]:cursor-pointer"
                />
                <button
                  onClick={() => { }}
                  className="p-2 text-gray-400 dark:text-white/50 hover:text-gray-900 dark:hover:text-white transition-colors"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
